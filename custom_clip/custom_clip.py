...
from custom_clip.custom_model import build_model
...
def load(name: str, args, device: Union[str, torch.device] = "cuda" if torch.cuda.is_available() else "cpu", jit=True,
    ...
    """
    design_details = {"trainer": args.trainer,
                      "vision_depth": args.prompt_depth_vision,
                      "language_depth": args.prompt_depth_text,
                      "vision_ctx": args.prompt_width,
                      "language_ctx": args.prompt_width,
                      "maple_length": args.prompt_width}
    if name in _MODELS:
